...
public class JointDataWriter {
    ...
    public void deleteLastSample(int session_number, string dataWritePath)
    {
        ...
        this.phrase_file_count--;
        File.Delete(dataWritePath + session_number + "\\" + this.current_phrase + "_" + session_number + ".txt");
        this.writeOn = false;
        Debug.Log("SAMPLE DELETED");
        //}
    }
    ...
    {
        this.writeOn = true;
        this.filePath = dataWritePath + session_number + "\\" + this.current_phrase + "_" + session_number + ".txt";
    ...
    public void markAsBadSample(int session_number, string dataWritePath)
    {
        ...
        String bad_sample_file = this.filePath = dataWritePath + session_number + "\\" + "bad_sample.txt";
